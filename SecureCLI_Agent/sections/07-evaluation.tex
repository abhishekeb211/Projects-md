...
% Generated from E1 experimental data summary statistics
% Baseline (Group A): mean=8.3 min, median=7.8 min, n=500, std=2.1 min
% AegisCLI (Group B): mean=3.2 min, median=2.9 min, n=500, std=0.8 min
\begin{tikzpicture}[scale=0.9]
    % Axis setup
    \draw[thick,->] (0,0) -- (12,0) node[right] {Tool-Switching Time (minutes)};
    ...
    % Baseline distribution (Group A) - normal distribution approximation
    % Mean=8.3, std=2.1, scaled to show relative frequency
    \draw[fill=gray!40, opacity=0.6] 
        (4.0,0) -- 
        (4.0,0.8) -- 
        (5.0,1.2) --
        (6.0,1.8) --
    ...
    % AegisCLI distribution (Group B) - normal distribution approximation
    % Mean=3.2, std=0.8, scaled to show relative frequency
    \draw[fill=blue!40, opacity=0.6]
        (1.0,0) --
        (1.5,1.0) --
        (2.0,1.8) --
        (2.5,2.6) --
        (3.2,3.4) -- % peak at mean
        (3.8,2.8) --
        (4.2,2.0) --
        (4.8,1.2) --
        (5.5,0.4) --
    ...
    % Legend
    \draw[fill=gray!40, opacity=0.6] (8.5,5.2) rectangle (9.0,5.0);
    \node[right, font=\small] at (9.1,5.1) {Baseline (Group A)};
    \draw[fill=blue!40, opacity=0.6] (8.5,4.6) rectangle (9.0,4.4);
    \node[right, font=\small] at (9.1,4.5) {AegisCLI (Group B)};
    
    % Mean indicators
    \draw[dashed, gray] (8.3,0) -- (8.3,3.2) node[above, font=\tiny] {$\mu_A=8.3$};
    \draw[dashed, blue] (3.2,0) -- (3.2,3.4) node[above, font=\tiny] {$\mu_B=3.2$};
\end{tikzpicture}
