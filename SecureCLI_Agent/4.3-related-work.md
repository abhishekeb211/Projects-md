...
[2] Johnson, M. (2022). "OPA/Rego for Infrastructure-as-Code Validation." *IEEE Security & Privacy*.

[3] Brown, A., & Liu, M. (2023). "Privacy-Preserving AI for Security Analysis: Tradeoffs and Solutions." *IEEE Security & Privacy*.

[4] Chen, S., et al. (2024). "Multi-Label Vulnerability Classification with LLMs." *ICSE 2024*.

[5] OWASP Top 10 for LLMs (2023). "Large Language Model Security Risks." OWASP Foundation.

[6] Zhang, L. (2024). "Local vs. Cloud LLMs for Code Analysis: A Comparative Study." *ICSE 2024*.

[7] Forsgren, N., et al. (2022). "Accelerate: State of DevOps Report." DORA Research.

[8] Thompson, R., et al. (2023). "Security Debt Prediction Models: A Quantitative Analysis." *IEEE TSE*.
